...
- [Whisper](https://f-droid.org/en/packages/org.woheller69.whisper/) - Android app for transcription and translation. Android Input Method Editor (IME), Android Voice Input. (FOSS)
